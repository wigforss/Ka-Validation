...
public class ArrayXmlValidatorTest {
    @Mock
    private ConstraintValidatorContext context;
    
    @TestedObject
    private ArrayXmlValidator validator;
    ...
    public void testInlineXml() {
       ...
       assertTrue(validator.isValid(new String[]{xml, xml2}, context));
       assertFalse(validator.isValid(new String[]{xml,brokenXml}, context));
    ...
    public void testInlineXmlAndSchemaFromUrl() {
        ...
        assertTrue(validator.isValid(new String[]{validSpringXml, validSpringXml2}, context));
        assertFalse(validator.isValid(new String[]{validSpringXml,invalidSpringXml}, context));
    }
    ...
    public void testInlineXmlWithSchemaValidation() {
       ...
       assertTrue(validator.isValid(new String[]{xml}, context));
       assertFalse(validator.isValid(new String[]{xmlWithExtraElement}, context));
