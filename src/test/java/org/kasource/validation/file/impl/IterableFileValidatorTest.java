...
public class IterableFileValidatorTest {
    @Mock
    ...
    @TestedObject
    private IterableFileValidator validator;
    ...
    public void testExistingFile() {
        ...
        String thisFile = ("src.test.java." + IterableFileValidatorTest.class.getName()).replace('.', java.io.File.separatorChar) + ".java";
        thisFile = System.getProperty("user.dir") + java.io.File.separatorChar + thisFile;
        assertTrue(validator.isValid(new ListBuilder<String>().add(thisFile).build(), context));
        assertFalse(validator.isValid(new ListBuilder<String>().add(thisFile, UUID.randomUUID().toString()).build(), context));
    }
    ...
    public void testExistingDirectory() {
        ...
        assertTrue(validator.isValid(new ListBuilder<String>().add(System.getProperty("user.dir")).build(), context));
        assertFalse(validator.isValid(new ListBuilder<String>().add(System.getProperty("user.dir"), UUID.randomUUID().toString()).build(), context));
    }
    ...
    public void testExecutableFile() {
        ...
        assertTrue(validator.isValid(new ListBuilder<String>().add(javaExecutable).build(), context));
        assertFalse(validator.isValid(new ListBuilder<String>().add(javaExecutable, UUID.randomUUID().toString()).build(), context));
    }
}
